...
architecture behav of vending_machine is 
    ...
    "vending_machine_vending_machine,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.203500,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=33,HLS_SYN_LUT=155,HLS_VERSION=2024_1}";
    ...
    signal select_ln189_fu_378_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln138_fu_403_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal nickel_in_read_read_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln124_fu_424_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln110_fu_445_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln95_fu_466_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln79_fu_487_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal or_ln79_fu_372_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln138_1_fu_387_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln138_fu_395_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln124_1_fu_408_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln124_fu_416_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal select_ln110_1_fu_429_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln110_fu_437_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln95_1_fu_450_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln95_fu_458_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln79_1_fu_471_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln79_fu_479_p3 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    ap_phi_mux_s_next_1_phi_fu_150_p34_assign_proc : process(s, s_next_load_fu_367_p1, ap_CS_fsm_state1, select_ln189_fu_378_p3, zext_ln138_fu_403_p1, nickel_in_read_read_fu_120_p2, zext_ln124_fu_424_p1, zext_ln110_fu_445_p1, zext_ln95_fu_466_p1, zext_ln79_fu_487_p1)
    begin
        if (((nickel_in_read_read_fu_120_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (s_next_load_fu_367_p1 = ap_const_lv32_4))) then 
            ...
            ap_phi_mux_s_next_1_phi_fu_150_p34 <= zext_ln79_fu_487_p1;
            ...
            ap_phi_mux_s_next_1_phi_fu_150_p34 <= zext_ln95_fu_466_p1;
            ...
            ap_phi_mux_s_next_1_phi_fu_150_p34 <= zext_ln110_fu_445_p1;
            ...
            ap_phi_mux_s_next_1_phi_fu_150_p34 <= zext_ln124_fu_424_p1;
            ...
            ap_phi_mux_s_next_1_phi_fu_150_p34 <= zext_ln138_fu_403_p1;
            ...
            ap_phi_mux_s_next_1_phi_fu_150_p34 <= select_ln189_fu_378_p3;
    ...
    or_ln79_fu_372_p2 <= (quarter_in or dime_in);
    s_next_load_fu_367_p1 <= s;
    select_ln110_1_fu_429_p3 <= 
        ap_const_lv3_4 when (dime_in(0) = '1') else 
        ap_const_lv3_7;
    select_ln110_fu_437_p3 <= 
        select_ln110_1_fu_429_p3 when (or_ln79_fu_372_p2(0) = '1') else 
        ap_const_lv3_2;
    select_ln124_1_fu_408_p3 <= 
        ap_const_lv4_5 when (dime_in(0) = '1') else 
        ap_const_lv4_8;
    select_ln124_fu_416_p3 <= 
        select_ln124_1_fu_408_p3 when (or_ln79_fu_372_p2(0) = '1') else 
        ap_const_lv4_3;
    select_ln138_1_fu_387_p3 <= 
        ap_const_lv4_6 when (dime_in(0) = '1') else 
        ap_const_lv4_9;
    select_ln138_fu_395_p3 <= 
        select_ln138_1_fu_387_p3 when (or_ln79_fu_372_p2(0) = '1') else 
        ap_const_lv4_4;
    select_ln189_fu_378_p3 <= 
        ap_const_lv32_0 when (thanks_in(0) = '1') else 
        ap_const_lv32_A;
    select_ln79_1_fu_471_p3 <= 
        ap_const_lv3_2 when (dime_in(0) = '1') else 
        ap_const_lv3_5;
    select_ln79_fu_479_p3 <= 
        select_ln79_1_fu_471_p3 when (or_ln79_fu_372_p2(0) = '1') else 
        ap_const_lv3_0;
    select_ln95_1_fu_450_p3 <= 
        ap_const_lv3_3 when (dime_in(0) = '1') else 
        ap_const_lv3_6;
    select_ln95_fu_458_p3 <= 
        select_ln95_1_fu_450_p3 when (or_ln79_fu_372_p2(0) = '1') else 
        ap_const_lv3_1;
    zext_ln110_fu_445_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln110_fu_437_p3),32));
    zext_ln124_fu_424_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln124_fu_416_p3),32));
    zext_ln138_fu_403_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln138_fu_395_p3),32));
    zext_ln79_fu_487_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln79_fu_479_p3),32));
    zext_ln95_fu_466_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln95_fu_458_p3),32));
end behav;
