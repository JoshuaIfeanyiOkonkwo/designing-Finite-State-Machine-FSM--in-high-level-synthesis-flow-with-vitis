; ModuleID = 'C:/Users/joshu/Desktop/exercise_5/hls_vending_machine/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
declare void @vending_machine_hw_stub(i1 zeroext, i1 zeroext, i1 zeroext, i1 zeroext, i1* noalias nocapture nonnull, i1* noalias nocapture nonnull, %"struct.ap_uint<2>"* noalias nocapture nonnull)
