...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vending_machine.autotvin.dat"
	set constFileTvOut       "vending_machine.autotvout.dat"
	set constFileHdlTvIn     "vending_machine.autohdltvin.dat"
	set constFileHdlTvOut    "vending_machine.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
