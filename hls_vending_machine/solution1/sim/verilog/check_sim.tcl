...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.vending_machine.autotvin_nickel_in.dat"
         "c.vending_machine.autotvin_dime_in.dat"
         "c.vending_machine.autotvin_quarter_in.dat"
         "c.vending_machine.autotvin_thanks_in.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.vending_machine.autotvout_candy_out.dat"
         "rtl.vending_machine.autotvout_nickel_out.dat"
         "rtl.vending_machine.autotvout_dime_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
