...
if {[file isfile vending_machine.autotvin.dat]} {
	file delete -force vending_machine.autotvin.dat
}

if {[file isfile vending_machine.autotvout.dat]} {
	file delete -force vending_machine.autotvout.dat
}
