...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_pulse_detector_0_3 -prefix
--               design_1_pulse_detector_0_3_ design_1_pulse_detector_0_0_sim_netlist.vhdl
...
entity design_1_pulse_detector_0_3_pulse_detector is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
...
end design_1_pulse_detector_0_3_pulse_detector;

architecture STRUCTURE of design_1_pulse_detector_0_3_pulse_detector is
...
entity design_1_pulse_detector_0_3 is
  ...
  attribute NotValidForBitStream of design_1_pulse_detector_0_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_pulse_detector_0_3 : entity is "design_1_pulse_detector_0_0,pulse_detector,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_pulse_detector_0_3 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_pulse_detector_0_3 : entity is "HLS";
  attribute x_core_info : string;
  attribute x_core_info of design_1_pulse_detector_0_3 : entity is "pulse_detector,Vivado 2024.1";
end design_1_pulse_detector_0_3;

architecture STRUCTURE of design_1_pulse_detector_0_3 is
...
begin
U0: entity work.design_1_pulse_detector_0_3_pulse_detector
     port map (
      ap_clk => ap_clk,
      ap_rst => '0',
      out_r(0) => out_r,
