...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debouncer is
  signal add_ln44_fu_123_p2 : STD_LOGIC_VECTOR ( 30 downto 0 );
  signal ap_condition_35 : STD_LOGIC;
  ...
  signal \pulse_sent[0]_i_1_n_0\ : STD_LOGIC;
  signal \pulse_sent_reg_n_0_[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \btn_out[0]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter[30]_i_12\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter[30]_i_5\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \pulse_sent[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state[1]_i_5\ : label is "soft_lutpair1";
begin
\btn_out[0]_INST_0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\counter[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFE2E2FFE20000E2"
    )
        port map (
      I0 => \counter_reg_n_0_[1]\,
      I1 => ap_condition_35,
      I2 => add_ln44_fu_123_p2(1),
      I3 => \state_reg_n_0_[1]\,
      I4 => \state_reg_n_0_[0]\,
      I5 => btn_in(0),
...
\counter[30]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\counter[30]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \counter[30]_i_12_n_0\,
      I2 => \counter[30]_i_13_n_0\,
      I3 => \counter_reg_n_0_[12]\,
      I4 => \counter_reg_n_0_[25]\,
      I5 => \counter_reg_n_0_[17]\,
      O => \counter[30]_i_6_n_0\
    );
\counter[30]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\counter[30]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\counter_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(12 downto 9),
...
\counter_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(16 downto 13),
...
\counter_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(20 downto 17),
...
\counter_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(24 downto 21),
...
\counter_reg[28]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(28 downto 25),
...
\counter_reg[30]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1 downto 0) => add_ln44_fu_123_p2(30 downto 29),
      S(3 downto 2) => B"00",
      S(1) => \counter[30]_i_7_n_0\,
      S(0) => \counter[30]_i_8_n_0\
    );
...
\counter_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(4 downto 1),
...
\counter_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => add_ln44_fu_123_p2(8 downto 5),
...
\counter_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => ap_clk,
      CE => ap_condition_35,
      D => add_ln44_fu_123_p2(9),
      Q => \counter_reg_n_0_[9]\,
      R => counter0_in(29)
    );
\pulse_sent[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2CAE"
    )
        port map (
      I0 => \pulse_sent_reg_n_0_[0]\,
      I1 => \state_reg_n_0_[1]\,
      I2 => \state_reg_n_0_[0]\,
      I3 => btn_in(0),
      O => \pulse_sent[0]_i_1_n_0\
    );
\pulse_sent_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => ap_clk,
      CE => '1',
      D => \pulse_sent[0]_i_1_n_0\,
      Q => \pulse_sent_reg_n_0_[0]\,
      R => '0'
    );
\state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF00008A00FF00"
    )
        port map (
      I0 => \state[1]_i_2_n_0\,
      I1 => \state[1]_i_3_n_0\,
...
\state[1]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(30),
      I1 => add_ln44_fu_123_p2(1),
      I2 => add_ln44_fu_123_p2(27),
      I3 => add_ln44_fu_123_p2(15),
      O => \state[1]_i_10_n_0\
    );
\state[1]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(18),
      I1 => add_ln44_fu_123_p2(8),
      I2 => add_ln44_fu_123_p2(26),
      I3 => add_ln44_fu_123_p2(5),
      O => \state[1]_i_11_n_0\
    );
\state[1]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(13),
      I1 => add_ln44_fu_123_p2(4),
      I2 => add_ln44_fu_123_p2(10),
      I3 => add_ln44_fu_123_p2(9),
      O => \state[1]_i_12_n_0\
    );
\state[1]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(29),
      I1 => add_ln44_fu_123_p2(3),
      I2 => \counter_reg_n_0_[0]\,
      I3 => add_ln44_fu_123_p2(16),
      O => \state[1]_i_13_n_0\
    );
...
\state[1]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => add_ln44_fu_123_p2(6),
      I4 => add_ln44_fu_123_p2(22),
      I5 => add_ln44_fu_123_p2(12),
      O => \state[1]_i_4_n_0\
    );
...
\state[1]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(17),
      I1 => add_ln44_fu_123_p2(2),
      I2 => add_ln44_fu_123_p2(21),
      I3 => add_ln44_fu_123_p2(20),
      O => \state[1]_i_7_n_0\
    );
\state[1]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(25),
      I1 => add_ln44_fu_123_p2(19),
      I2 => add_ln44_fu_123_p2(28),
      I3 => add_ln44_fu_123_p2(7),
      O => \state[1]_i_8_n_0\
    );
\state[1]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => add_ln44_fu_123_p2(23),
      I1 => add_ln44_fu_123_p2(14),
      I2 => add_ln44_fu_123_p2(24),
      I3 => add_ln44_fu_123_p2(11),
      O => \state[1]_i_9_n_0\
    );
